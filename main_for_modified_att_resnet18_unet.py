...
from modified_attention_resnet18_unet_1 import modified_att_resnet18_unet_1
from modified_attention_resnet18_unet_2 import modified_att_resnet18_unet_2
...
# resize cam for replacing gating signal of modified_att_resnet18_unet models, get specific pred
...
def main():
    ...
    # choose a model from modified att resnet18_unet models
    # replace all gating signals, resize cams but still in 1 channel
    model = modified_att_resnet18_unet_1()
    model_id = 1

    # only replace the high resolution signal,resize cams but still in 1 channel
    # model = modified_att_resnet18_unet_2() 
    # model_id =2
    ...
    model_classifier = torch.load('/home/WIN-UNI-DUE/sotiling/WS20/pmb_ws20_dl-pet-ac-attention/re_trained_grad_cam_classifier/grad_cam_new/classification_rec_complete_neu3', map_location=torch.device('cuda'))
