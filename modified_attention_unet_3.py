...
# gating signal with lowest resolution of the 1st attention gate was replaced by Grad-CAN
...
class modified_att_unet_3(nn.Module):
    def __init__(self,img_ch=1,output_ch=1):
        super(modified_att_unet_3,self).__init__()
    ...
    def forward(self,x,cam):
        ...
        x4_att = self.Att5(cam,x4) # d5 was replaced by Grad-CAM
