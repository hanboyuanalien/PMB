...
# gating signals of the 1st, 2nd and 3rd attention gates were replaced
...
class modified_att_unet_5(nn.Module):
    def __init__(self,img_ch=1,output_ch=1):
        super(modified_att_unet_5,self).__init__()
        ...
        self.Att3 = Attention_block(F_g=1,F_l=128,F_int=64) # replace gating signal with 3 lowest resolution
    ...
    def forward(self,x,cam1,cam2,cam3):
        # encoding path
