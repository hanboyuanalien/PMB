...
# gating signal of 4th attention gate was replaced by Grad-CAM 
...
class modified_att_resnet18_unet_2(nn.Module): 
    def __init__(self):
        super().__init__()
    ...
    def forward(self,input,cam):
        ...
        x1_att = self.Att2(cam,e1) # d2 was replaced by cam
...
#     model = modified_att_resnet18_unet_2().to(device)
#     print(model)
